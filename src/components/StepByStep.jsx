  ...
  return (
    <section className="py-16 lg:py-20 bg-white">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-xl lg:text-2xl font-bold tracking-tight text-center text-ifb-text mb-12">
          Simples e rápido
        </h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {steps.map((s) => (
            <div key={s.num} className="text-center">
              ...
              <h3 className="text-base font-semibold tracking-tight text-ifb-text mb-1.5">{s.title}</h3>
